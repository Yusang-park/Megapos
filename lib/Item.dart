...
class _ItemTileState extends State<ItemTile> {
        ...
        children: [
          ...
          Expanded(
            ...
            child: Container(
              ...
              margin: EdgeInsets.only(left: 5.0, right: 15.0), //왼쪽 마진 5.0, 오른쪽 마진 15.0
  ...
  void _plusStock() {
    ...
    setState(() {
      if(widget.selectedStock < widget.item.stock)
        widget.selectedStock++;
    });
  }
}
    ...
    setState(() {
      _stream = NFC.readNDEF(
        ...
        if(isSelected)    //이미 선택된 상품이라면
          widget.basket[i].selectedStock++;  //-->재고량은 증가하는데 화면이 안바뀜 큰일이구만 -> _ItemTileState의 plusStock()함수를 호출하면 Best!
        else
